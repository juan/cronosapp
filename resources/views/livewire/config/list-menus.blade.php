    ...
    <div class="modal-dialog  w-8/12">
        <div class="modal-content w-full">
            <div class="modal-header w-full h-2">
                <h2 class="modal-title">Listado de accesos</h2>
            ...
            <div class="modal-body ">
                ...
                <div class="flex flex-col w-full">
                    @if(count($listRoles)>0)
                        ...
                        <x-smalltable cabecera="Perfil,Accesos,Opciones"
                            ...
                            @foreach($listRoles as $dataaccrole)
                                <tr>
                                    ...
                                    px-2 py-1 text-xs font-body text-primary">
                                              {{ $dataaccrole->menus_count}}</span>
                                    </td>
                                    <td class="px-4">
                                        <x-opcion-table editon="yes" viewon="yes">
                                            <x-slot:funciowiew>
                                                loadMenuRoleInfo({{$dataaccrole->id}},'view')
                                            </x-slot:funciowiew>
                                            <x-slot:funcioupdate>
                                                loadMenuRoleInfo({{$dataaccrole->id}},'update')
                                            </x-slot:funcioupdate>

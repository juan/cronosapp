...
bg-green-800 dark:bg-green-200 border border-transparent rounded-md
...
dark:focus:ring-offset-gray-800 transition ease-in-out duration-150  border-b-4 border-green-300']) }}>
    {{ $slot }}
</button>

...
<header class="top-bar">
    ...
    <form class="hidden md:block ltr:ml-10 rtl:mr-10">
        <label class="form-control-addon-within rounded-full">
            <input class="form-control border-none" placeholder="Buscar...">
            <button
    ...
    <div class="flex items-center ltr:ml-auto rtl:mr-auto">
        ...
        <!-- Dark Mode -->
        <label class="switch switch_outlined" data-toggle="tooltip" data-tippy-content="Modo oscuro">
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center px-5 py-2">
                    <h5 class="mb-0 uppercase">Mensajes</h5>
